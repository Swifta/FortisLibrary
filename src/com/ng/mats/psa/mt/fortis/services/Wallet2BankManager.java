...
public class Wallet2BankManager {
	private static final Logger logger = Logger
			.getLogger(Wallet2BankManager.class.getName());

	public Response initiateWalletToBank(MoneyTransfer moneyTransfer) {
		moneyTransfer.setTxnName(Constants.TXNW2BINQUIRY);
		...
		nameValuePairList.add(new NameValuePair("narration", moneyTransfer
				.getNaration()));
		logger.info("-----------------------After setting narration");

		nameValuePairList.add(new NameValuePair("benOpCode", moneyTransfer
				.getBenOpCode()));
		logger.info("-----------------------After setting benOpCode");
	...
	public Response confirmWalletToBank(MoneyTransfer moneyTransfer) {
		moneyTransfer.setTxnName(Constants.TXNW2B);
		moneyTransfer.setService(Constants.agent);
		logger.info("-----------------------Before initiating namve value pair");
		List<NameValuePair> nameValuePairList = new ArrayList<NameValuePair>();
